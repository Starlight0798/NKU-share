% main() is the main function of the Superimposition_Gray program.
function main()
    ...
    imshow(enc_img);
    title("enc\_img");
    imwrite(enc_img, './pic/Superimposition_Gray/enc_img.jpeg');

    gray_enc_img = rgb2gray(enc_img);
    disp("The size of the gray_enc_img is: ");
    disp(size(gray_enc_img));
    figure;
    imshow(gray_enc_img);
    title("gray\_enc\_img");
    imwrite(gray_enc_img, './pic/Superimposition_Gray/gray_enc_img.bmp');
    ...
    imwrite(original_img1, './pic/Superimposition_Gray/original_img1.jpeg');

    gray_original_img1 = rgb2gray(original_img1);
    disp("The size of the gray_original_img1 is: ");
    disp(size(gray_original_img1));
    figure;
    imshow(gray_original_img1);
    title("gray\_original\_img1");
    imwrite(gray_original_img1, './pic/Superimposition_Gray/gray_original_img1.bmp');
    ...
    imwrite(original_img2, './pic/Superimposition_Gray/original_img2.jpeg');

    gray_original_img2 = rgb2gray(original_img2);
    disp("The size of the gray_original_img2 is: ");
    disp(size(gray_original_img2));
    figure;
    imshow(gray_original_img2);
    title("gray\_original\_img2");
    imwrite(gray_original_img2, './pic/Superimposition_Gray/gray_original_img2.bmp');

    halftone_gray_enc_img = img_halftone(gray_enc_img);
    disp("The size of the halftone_gray_enc_img is: ");
    disp(size(halftone_gray_enc_img));
    figure;
    imshow(halftone_gray_enc_img);
    title("halftone\_gray\_enc\_img");
    imwrite(halftone_gray_enc_img, './pic/Superimposition_Gray/halftone_gray_enc_img.bmp');

    halftone_gray_original_img1 = img_halftone(gray_original_img1);
    disp("The size of the halftone_gray_original_img1 is: ");
    disp(size(halftone_gray_original_img1));
    figure;
    imshow(halftone_gray_original_img1);
    title("halftone\_gray\_original\_img1");
    imwrite(halftone_gray_original_img1, './pic/Superimposition_Gray/halftone_gray_original_img1.bmp');

    halftone_gray_original_img2 = img_halftone(gray_original_img2);
    disp("The size of the halftone_gray_original_img2 is: ");
    disp(size(halftone_gray_original_img2));
    figure;
    imshow(halftone_gray_original_img2);
    title("halftone\_gray\_original\_img2");
    imwrite(halftone_gray_original_img2, './pic/Superimposition_Gray/halftone_gray_original_img2.bmp');
    ...
    imshow(img1);
    title("img1");
    imwrite(img1, './pic/Superimposition_Gray/img1.bmp');
    disp("The size of the img2 is: ");
    disp(size(img2));
    figure;
    imshow(img2);
    title("img2");
    imwrite(img2, './pic/Superimposition_Gray/img2.bmp');
    ...
    imshow(merged_img);
    title("merged\_img");
    imwrite(merged_img, './pic/Superimposition_Gray/merged_img.bmp');
end
